        ...
        <Component>
            <Box>
                ...
                <Wrapper>
                    ...
                    <Text varient="h6"style={{textAlign:'center'}}>OR</Text>
                    <SignUpButton onClick={toggleHandle}>Create an account</SignUpButton>
                </Wrapper> 
                :
                <Wrapper>
                ...
                {error && <Error>{error}</Error>}
                    ...
                    <Text varient="h6" style={{ textAlign: 'center' }}>OR</Text>
                    <LoginButton onClick={toggleHandle} variant='contained'>Already have an Account</LoginButton>
                </Wrapper>
}
            </Box>
